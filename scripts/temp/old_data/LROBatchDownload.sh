...
img_saveDir="/Users/mrichardson/Desktop/Incidence_Angle_Analysis/download/"
img_type=".png"
...
do
    ...
    ###########################################################
    if [ ! -d ${img_saveDir}${imagename} ]
    then
       mkdir ${img_saveDir}${imagename}
    fi
	...
	saveFile="${img_saveDir}${imagename}/${filename}"
	if [ ! -f ${saveFile} ]
	then
