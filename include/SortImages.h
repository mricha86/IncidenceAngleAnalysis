...
class SortImages
{
  ...
  public:
    ...
    static bool cmp_by_maximum_latitude(Images &, Images &);
    static bool cmp_by_maximum_longitude(Images &, Images &);
    static bool cmp_by_maximum_x(Images &, Images &);
    static bool cmp_by_maximum_y(Images &, Images &);
    static bool cmp_by_minimum_latitude(Images &, Images &);
    static bool cmp_by_minimum_longitude(Images &, Images &);
    static bool cmp_by_minimum_x(Images &, Images &);
    static bool cmp_by_minimum_y(Images &, Images &);
