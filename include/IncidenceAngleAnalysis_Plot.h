...
class IncidenceAngleAnalysis_Plot
{
  ...
  public:
    ...
    static void CumulativeCraterDensity(TH1F *, double, std::vector <double> &, std::vector <double> &);
    ...
    static void RelativeCraterDensity(TH1F *, double, std::vector <double> &, std::vector <double> &);
