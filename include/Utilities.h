...
class Utilities {
  ...
  public:
    ...
    static std::vector <OverlappedImages> FindSameScaleOverlappingImages(std::vector <OverlappedImages> &, int);
    ...
    static void PrintCraterPopulationData(std::string, std::string, double, double, TH1F *hist, std::vector <double> &, std::vector <double> &, std::vector <double> &, std::vector <double> &);
