...
class Utilities
{
  ...
  public:
    ...
    static std::vector <OverlappedImages> FindOverlappingImages(std::vector <Images> &, std::vector <IncidenceAngles> &, std::vector <MasterImageOrientation> &);
    ...
    static void ExecuteImageSetsAuxilaryFunction(std::vector <ImageSets> &, std::vector <MasterImageOrientation> &);
